...
function addNext(){
	 var url = "${webRoot}/rcode/saveInfo?name="+$("#name").val();
	 $.post(url,function(data){
		if(data=="01"){
			window.location.href="<%=path%>/rcode/listContent";
		}else{
...
function update(i){
	var id1 = $("#id_"+i).attr("value");
	 var url = "${webRoot}/rcode/updateInfo?id="+id1+"&name="+$("#name").val();
	 $.post(url,function(data){
		if(data=="01"){
			window.location.href="<%=path%>/rcode/listContent";
		}else{
...
function openDelModel(id){
	...
	var url = "${webRoot}/rcode/deletebyid?id="+id1;
	$.post(url,function(data){
		if(data=="1"){
			window.location.href="<%=path%>/rcode/listContent";
		} else {

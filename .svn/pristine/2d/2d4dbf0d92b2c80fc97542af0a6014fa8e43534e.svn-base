...
function excelexport(){
	if(confirm("确定要导出？")){
		var url = "<%=path%>/requirement/export?bm=运营需求管理";
...
<body style="margin:0; padding:0">
	...
	<div class="content_waikuang">
		<div class="container-fluid search_select" style="padding-left: 0">
			...
			<h2 id="obm" class="content_title">运营需求管理</h2>
 ...
 <input type="hidden" id="bmoc">
		...
		<div class="row" style="clear: both">
			...
			<div class="span9" style="width: 98%; margin-top: -20px">
					...
					<table style="clear: both">
						...
						<tr>
							...
							<td>提出时间 <input class="laydate-icon"
								...
								name='requireMent.proposeTimeF' id="proposeTime" style="width: 150px"
								nullmsg="请输入提出时间！">
								&nbsp-&nbsp
								<input class="laydate-icon"
								onclick="laydate({istime: true, format: 'YYYY-MM-DD'})"
								name='requireMent.proposeTimeT' id="proposeTime" style="width: 150px"
								nullmsg="请输入提出时间！"></td>
						</tr>
						<tr>
							<td>要求时间 <input class="laydate-icon"
								onclick="laydate({istime: true, format: 'YYYY-MM-DD'})"
								name='requireMent.requestTimeF' id="requestTime" style="width: 120px"
								nullmsg="请输入要求时间！">
								&nbsp-&nbsp
								<input class="laydate-icon"
								onclick="laydate({istime: true, format: 'YYYY-MM-DD'})"
								name='requireMent.requestTimeT' id="requestTime" style="width: 120px"
								nullmsg="请输入要求时间！"></td>
							<td></td>
				...
				style="text-align: right; margin-right: 15px">
				<a class="renwu_select" href="${path}/jobManage/requirement/add">添加需求</a>
				<a class="renwu_select" onclick="excelexport()">导出excel</a>
			</div>

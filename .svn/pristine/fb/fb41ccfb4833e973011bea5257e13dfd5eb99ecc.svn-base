package com.inspur.kafka.crawl.memory;
...
public abstract class CassandraOpsBase {
    ...
    protected void loadConfiguration() {
        ...
        try {
            ...
            prop.load(s);
            this.CassandraClusterContactPoints = prop.getProperty("cluster.contactPoints", "127.0.01");
    ...
    protected void prepare(){
    	if(this.CassandraClusterContactPoints==null || this.CrawlerDbKeyspaceName==null) {
    		loadConfiguration();
    	}

        this.cluster = Cluster.builder()
                .addContactPoints(this.CassandraClusterContactPoints.split(","))
                .build();
